  ...
  return (
    <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 26px 14px", borderBottom: `2px solid ${C.ink}` }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <button onClick={onLock} style={{ width: 38, height: 38, borderRadius: "50%", border: `1.5px solid ${C.ink}`, background: "transparent", color: C.ink, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><IconLock /></button>
      </div>
    </header>
  );
}
